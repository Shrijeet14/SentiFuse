...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/Shrijeet14/SentiFuse.mlflow")  # Replace with your MLflow tracking URI
    client = MlflowClient()
...
def predict_with_timestamps():
    ...
    try:
        ...
        transformed_comments = vectorizer.transform(preprocessed_comments)
        transformed_df = pd.DataFrame(transformed_comments.toarray(), columns=vectorizer.get_feature_names_out())
